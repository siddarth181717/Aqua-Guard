...
----------------------------------------
Applies migrations, enables PostGIS, and seeds initial real data if empty.
"""
...
def init_db(db: Session) -> None:
    ...
    # Seed baseline water bodies if table is empty
    if db.query(WaterBody).count() == 0:
        print("[INFO] Seeding initial water bodies into database...")
        wb1 = WaterBody(
